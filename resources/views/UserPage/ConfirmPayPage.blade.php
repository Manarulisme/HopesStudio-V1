...
<div class="max-w-md mx-auto bg-white p-6 shadow-md rounded-lg mt-10 flex-grow">
    ...
    <input type="text" placeholder="Masukkan Kode Bayar.." class="w-full p-2 border rounded mb-4 bg-gray-200">

    <label class="block text-gray-700">Nama Pengirim</label>
    <input type="text" placeholder="Masukkan Nama Pengirim Sesuai tertara di bukti transfer.." class="w-full p-2 border rounded mb-4 bg-gray-200">

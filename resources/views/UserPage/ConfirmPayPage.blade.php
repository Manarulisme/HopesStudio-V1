...
<div class="max-w-md mx-auto bg-white p-6 shadow-md rounded-lg mt-10 flex-grow">
    ...
    <form action="{{ route('sendKonfirmasiPembayaran') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <label class="block text-gray-700">Kode Bayar</label>
        <input type="text" value="{{ $pembayaran->kode_pembayaran }}" placeholder="Masukkan Kode Bayar.." class="w-full p-2 border rounded mb-4 bg-gray-200" name="kode_pembayaran" readonly>
        ...
        <button type="submit" class="w-full bg-blue-600 text-white p-2 rounded hover:bg-blue-700">Kirim Konfirmasi</button>
    </form>
</div>
